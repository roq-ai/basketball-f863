...
type ColumnType = ColumnDef<PlayerInterface, unknown>;
...
export function PlayerListPage(props: PlayerListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<PlayerInterface>>(
    () => `/players?params=${JSON.stringify(params)}`,
    fetcher,
  );
