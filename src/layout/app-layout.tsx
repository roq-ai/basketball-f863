...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Players', path: '/players', entity: 'player', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Referees', path: '/referees', entity: 'referee', service: AccessServiceEnum.PROJECT, icon: FiUserX },
